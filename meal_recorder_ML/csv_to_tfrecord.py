...
Usage:
  ...
  # Create train data:
  python csv_to_tfrecord.py --csv_input=train_labels.csv  --output_path=train.record
  # Create test data:
  python csv_to_tfrecord.py --csv_input=test_labels.csv  --output_path=test.record
"""
...
def create_tf_example(group, path):
    ...
    filename = group.object.iloc[0]["filename"].encode('utf8')
    print(filename)
    image_format = b'jpg'
    xmins = []
    xmaxs = []
